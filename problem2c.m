...
scatter(project2(:,1),project2(:,2),10,[test(:,d+1)],'fill');
xlabel('dimension-1');
ylabel('dimension-2');
title('plot of test 2 dimension of test set');


scatter3(project2(:,1),project2(:,2),project2(:,3),10,test(:,d+1),'fill');
xlabel('dimension-1');
ylabel('dimension-2');
zlabel('dimension-3');
title('plot of first 3 dimensions of test set');
